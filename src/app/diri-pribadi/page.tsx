...
import { DiriPribadiProductGrid } from '@/features/psikotes/components/product-grid'
...
export default function DiriPribadiPage() {
  return (
    <main className="min-h-screen bg-background">
      <section className="bg-gradient-to-b from-primary-900 to-primary-700 pt-32 pb-16">
