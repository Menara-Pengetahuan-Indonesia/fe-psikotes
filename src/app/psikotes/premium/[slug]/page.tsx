...
export default function PremiumTestDetailPage({ params }: { params: { slug: string } }) {
  const test = PREMIUM_TESTS.find((t) => t.slug === params.slug)
        ...
        <main className="max-w-4xl mx-auto px-6 pt-32 pb-24">
          ...
          <div className="text-center max-w-2xl mx-auto space-y-8 mb-16">
            <div className="space-y-4">
              ...
              {test?.price && (
                <span className="inline-block px-4 py-1.5 bg-black text-white rounded-full text-xs font-bold tracking-wider">
                  {test.price}
                </span>
              )}
            </div>
