    ...
    <div className="min-h-screen bg-[#F8F7FF]">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          ...
          <div className="max-w-xl mx-auto relative group">
            <div className="relative flex items-center bg-white rounded-3xl border border-slate-200 p-2 shadow-xl shadow-purple-900/20 focus-within:border-purple-500 transition-all">
              ...
              />
              <button className="hidden md:block px-8 py-4 bg-purple-900 text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-black transition-all shadow-lg shadow-purple-600/20">
                Cari Tes
              </button>
            </div>
          </div>
      ...
      <section className="py-20 px-6 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Special Section Break (Dark Purple) */}
          <div className="my-32 p-12 md:p-20 rounded-[3.5rem] relative overflow-hidden text-center text-white"
             ...
             <div className="relative z-10 space-y-6">
                ...
                <p className="text-lg text-purple-100 max-w-xl mx-auto font-medium opacity-80">
          ...
          <div className="mt-16 text-center">
            <button className="px-12 py-5 bg-white border-2 border-purple-900 text-purple-900 rounded-2xl text-xs font-black uppercase tracking-[0.2em] hover:bg-purple-900 hover:text-white transition-all shadow-xl shadow-purple-900/5">
