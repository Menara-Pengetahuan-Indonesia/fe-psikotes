...
export function Testimonials() {
  return (
    <section className="py-24 md:py-36 relative overflow-hidden bg-primary-950">
      {/* Background Decor */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-20 space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/10 shadow-sm mb-2">
            ...
            <span className="text-[10px] font-black tracking-[0.2em] text-primary-100 uppercase">
              User Stories
            </span>
          </div>
          <h2 className="text-4xl md:text-5xl font-black tracking-tight text-white leading-tight">
            Pengalaman <span className="text-accent-300">Terbaik</span> Mereka
          </h2>
          <p className="text-lg text-primary-200/70 max-w-2xl mx-auto font-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {TESTIMONIALS.map((testi) => (
            ...
            >
              <div className="absolute -top-5 -left-5 w-12 h-12 bg-primary-600 rounded-2xl flex items-center justify-center text-white shadow-lg group-hover:rotate-12 transition-transform duration-500">
              ...
              <p className="text-primary-50 mb-10 leading-relaxed font-medium italic text-lg tracking-tight">
                &quot;{testi.quote}&quot;
              </p>

              <div className="flex items-center gap-4 pt-6 border-t border-white/5">
                <div className="w-12 h-12 rounded-2xl bg-white/10 flex items-center justify-center font-black text-primary-200 text-lg border border-white/10">
                  {testi.name[0]}
                </div>
                <div>
                  <p className="font-black text-white text-base leading-none mb-1">{testi.name}</p>
                  <p className="text-[10px] text-primary-300/60 font-bold uppercase tracking-widest">{testi.role}</p>
                </div>
              </div>
            </div>
          ))}
