    ...
    <section className="py-24 px-6 bg-background">
      <div className="max-w-5xl mx-auto">
        <div className="relative group p-10 md:p-16 bg-white rounded-[3rem] border border-slate-100 text-center space-y-8 transition-all duration-500 hover:shadow-2xl hover:shadow-emerald-900/5 hover:-translate-y-1 shadow-xl shadow-stone-200/50 overflow-hidden">
          ...
          <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-amber-50 rounded-full blur-3xl opacity-50 group-hover:opacity-100 transition-opacity" />
          ...
          <div className="relative z-10 space-y-8">
            ...
            <div className="pt-4">
               <button className="px-10 py-4 bg-emerald-700 text-white rounded-2xl text-xs font-black uppercase tracking-widest hover:bg-emerald-600 transition-all shadow-lg hover:shadow-emerald-200">
