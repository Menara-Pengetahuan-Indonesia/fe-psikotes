            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isOpen
                    ? "border-emerald-500 shadow-xl shadow-emerald-900/5 ring-1 ring-emerald-500/10"
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className={cn(
                      ...
                      isOpen ? "bg-emerald-600 text-white" : "bg-slate-50 text-slate-400"
                    )}>
                  ...
                  <span
                    className={cn(
                      ...
                      isOpen ? "bg-emerald-50 text-emerald-600" : "bg-slate-50 text-slate-300"
                    )}
                  >
