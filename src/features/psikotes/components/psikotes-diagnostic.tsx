  ...
  return (
    <div className="w-full space-y-8">
      ...
      {phase === 'thinking' && messages.length === 1 && (
        <div className="max-w-xl mx-auto bg-white/10 rounded-3xl p-10 border border-white/20 flex flex-col items-center text-center gap-4 animate-in fade-in zoom-in-95 duration-500">
      ...
      {(phase === 'result' || (phase === 'thinking' && messages.length > 1)) && (
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="bg-white/10 rounded-3xl p-8 border border-white/20 flex flex-col gap-6 text-left relative h-[500px]">
            
            {/* FLOATING TOP LABEL (The "Cap") */}
            <div className="absolute -top-5 left-1/2 -translate-x-1/2 z-20 w-full flex justify-center">
               <div className="bg-white/10 px-5 py-2.5 rounded-2xl shadow-xl border border-white/20 flex items-center gap-3 animate-in slide-in-from-top-4 duration-1000">
