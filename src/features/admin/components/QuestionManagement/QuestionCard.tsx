  ...
  return (
    <div className="bg-white rounded-2xl border-2 border-indigo-400 shadow-lg shadow-indigo-100/50">
      ...
      <div className="px-5 py-5 space-y-5">
        ...
        {/* Image */}
        <div className="space-y-2">
          <label className="text-xs font-bold text-slate-500 uppercase tracking-wider">URL Gambar Soal (Opsional)</label>
          {imageUrl ? (
            ...
            <input
              ...
              placeholder="Paste URL gambar dari Cloudinary..."
                ...
                <div key={idx} className="rounded-xl border border-slate-200 bg-slate-50/50 p-3 space-y-2">
                  ...
                  {opt.imageUrl ? (
                    ...
                    <input
                      ...
                      placeholder="Paste URL gambar opsi dari Cloudinary..."
