...
export function MembershipHero() {
  return (
    <header className="relative overflow-hidden bg-primary-600 text-white pt-32 pb-20 md:pt-40 md:pb-32">
      ...
      <Plus className="absolute top-[15%] left-[10%] text-primary-400/40 w-8 h-8" />
      <Hexagon className="absolute top-[40%] right-[10%] text-white/10 w-24 h-24 -rotate-12" />
      <Diamond className="absolute bottom-[10%] left-[20%] text-accent-400/30 w-16 h-16 rotate-12" />

      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          {/* Left: Copy */}
          <div className="space-y-10 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary-700/50 border border-primary-400 shadow-lg backdrop-blur-md mb-2 mx-auto lg:mx-0">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg md:text-xl text-primary-50 max-w-lg leading-relaxed font-medium mx-auto lg:mx-0 opacity-90">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 pt-4 justify-center lg:justify-start">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col text-left">
                  <span className="text-[10px] text-primary-200 font-black uppercase tracking-widest leading-none">Lifetime</span>
