    ...
    <section className="py-24 md:py-36 bg-[#faf5e4] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <div className="order-2 md:order-1 relative">
          <div className="absolute inset-0 bg-indigo-600/5 transform -rotate-3 rounded-[3rem]" />
          <div className="relative bg-white border border-slate-100 rounded-[3rem] p-3 shadow-2xl shadow-indigo-900/5">
            <div className="aspect-video bg-slate-950 rounded-[2.5rem] flex items-center justify-center relative overflow-hidden">
              ...
              <div className="absolute inset-0 grid grid-cols-4 gap-2 p-4 opacity-20">
                {Array.from({ length: 12 }).map((_, i) => (
                  <div key={i} className="bg-indigo-500/20 rounded-2xl animate-pulse" style={{ animationDelay: `${i * 100}ms` }} />
                ))}
              </div>
              
              <div className="relative z-10 text-center space-y-4">
                <div className="w-20 h-20 bg-indigo-600/20 rounded-full mx-auto flex items-center justify-center backdrop-blur-md border border-white/10">
        ...
        <div className="order-1 md:order-2 space-y-8">
          ...
          <div className="pt-4">
             <button className="px-10 py-4 bg-slate-950 text-white rounded-2xl text-xs font-black uppercase tracking-widest hover:bg-indigo-600 transition-all shadow-xl shadow-slate-950/10">
