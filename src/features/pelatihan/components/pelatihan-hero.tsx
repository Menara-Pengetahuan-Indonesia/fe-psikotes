...
export function PelatihanHero() {
  return (
    <section className="relative overflow-hidden bg-linear-to-b from-pelatihan-800 via-pelatihan-700 to-pelatihan-500 py-20 md:py-36">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-150 h-150 bg-pelatihan-900/20 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-5%] w-125 h-125 bg-pelatihan-300/20 rounded-full blur-[120px] pointer-events-none" />
