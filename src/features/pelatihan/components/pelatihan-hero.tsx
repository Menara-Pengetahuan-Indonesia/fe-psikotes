...
export function PelatihanHero() {
  return (
    <section className="relative overflow-hidden bg-linear-to-b from-orange-800 via-orange-700 to-orange-500 py-20 md:py-36">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-150 h-150 bg-orange-900/20 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-5%] w-125 h-125 bg-orange-300/20 rounded-full blur-[120px] pointer-events-none" />

      {/* 3. Technical Ornaments (Non-Wave) */}
      {/* Plus Signs */}
      <Plus className="absolute top-[10%] left-[15%] text-orange-300/30 w-8 h-8 animate-pulse" />
      ...
      <div className="absolute top-10 left-[10%] w-32 h-32 bg-linear-to-br from-orange-500/20 to-orange-800/20 rounded-full blur-2xl opacity-40 animate-float-slow" />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-10">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-700/50 border border-orange-400 shadow-lg backdrop-blur-md animate-in fade-in slide-in-from-bottom-4 duration-700">
              <Sparkles className="w-4 h-4 text-amber-400 fill-amber-400" />
              <span className="text-[11px] font-black tracking-[0.2em] text-orange-50 uppercase">
                Future-Ready Skills
              </span>
            </div>
            ...
            <div className="space-y-6">
              ...
              <p className="text-xl text-orange-50 max-w-lg leading-relaxed font-medium opacity-90 text-pretty">
              ...
              {HERO_BENEFITS.map((b, idx) => (
                <div key={b.label}
                     className={cn(
                       ...
                       "bg-orange-700/40 border-orange-500/30 backdrop-blur-md hover:bg-orange-700/60 hover:shadow-2xl hover:shadow-orange-900/20"
                     )}
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-orange-100/70 text-xs leading-relaxed font-medium">{b.desc}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-8 pt-4">
              ...
              <div className="flex items-center gap-4">
                <div className="h-12 w-px bg-orange-500/50 hidden sm:block" />
                <div className="flex flex-col">
                  <span className="text-[10px] text-orange-200 font-black uppercase tracking-widest">Harga Mulai</span>
          ...
          <div className="hidden lg:block relative perspective-2000">
            ...
            <div className="relative w-full aspect-square max-w-137.5 mx-auto transform-style-3d animate-float-slow">
              ...
              {/* Main "Dashboard" Card */}
              <div className="absolute inset-10 bg-white rounded-[3rem] shadow-[0_30px_60px_-12px_rgba(0,0,0,0.3)] border-[6px] border-orange-500/20 flex flex-col overflow-hidden z-20 transform-style-3d">
                 <div className="h-32 bg-orange-50 p-8 flex justify-between items-center">
                    <div className="space-y-2">
                        <div className="w-20 h-3 bg-orange-200 rounded-full animate-pulse" />
                        <div className="w-32 h-5 bg-orange-600 rounded-full" />
                    </div>
                 ...
                 <div className="flex-1 p-10 space-y-8">
                    ...
                    <div className="space-y-3">
                        <div className="w-full h-2 bg-slate-100 rounded-full overflow-hidden">
                            <div className="w-3/4 h-full bg-orange-500 animate-in slide-in-from-left duration-1000" />
                        </div>
                        <div className="w-full h-2 bg-slate-100 rounded-full overflow-hidden">
              ...
              {/* Floating Assets */}
              <div className="absolute top-0 right-0 w-32 h-32 bg-orange-400 rounded-[2rem] rotate-12 z-30 animate-float-medium shadow-2xl border-4 border-white flex items-center justify-center text-4xl">
                  📚
              </div>
